import { Button, Tabs,Col, Popover, Row } from 'antd';
import { ModalForm, ProFormText, ProFormTextArea } from '@ant-design/pro-form';
import React, { useCallback, useEffect, useState } from 'react';
import { dayRegex, hourRegex, minuteRegex, monthRegex, secondRegex, weekRegex, yearRegex } from './cron-regex';
import DayPane from './DayPane/DayPane';
import HourPane from './HourPane/HourPane';
import MinutePane from './MinutePane/MinutePane';
import MonthPane from './MonthPane/MonthPane';
import SecondPane from './SecondPane/SecondPane';
import WeekPane from './WeekPane/WeekPane';
import YearPane from './YearPane/YearPane';
